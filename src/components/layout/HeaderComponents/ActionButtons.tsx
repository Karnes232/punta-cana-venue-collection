...
const ActionButtons = ({ isMenuOpen, setIsMenuOpen, isSearchOpen, setIsSearchOpen }: { isMenuOpen: boolean, setIsMenuOpen: (isMenuOpen: boolean) => void, isSearchOpen: boolean, setIsSearchOpen: (isSearchOpen: boolean) => void }) => {
  return (
