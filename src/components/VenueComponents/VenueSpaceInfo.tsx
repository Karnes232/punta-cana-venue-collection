...
const VenueSpaceInfo = ({ totalSpace, capacityCocktail, capacitySeated, locale = "en" }: VenueSpaceInfoProps) => {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white  rounded-lg p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className={`${coromantGaramond.className} text-2xl font-semibold text-gray-800`}>
            {t("totalSpace")}
          </h3>
        </div>
