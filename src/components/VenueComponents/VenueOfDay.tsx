...
const VenueOfDay = ({ venueOfTheDay, locale }: { venueOfTheDay: any, locale: string }) => {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      {/* Header */}
      <h2 className={`${coromantGaramond.className} text-2xl font-bold text-charcoal mb-6 text-center lg:text-left`}>Venue of the Day</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-1">
          ...
          <div className="md:col-span-2 relative h-64 md:h-auto">
            <Image 
              ...
              height={venueOfTheDay.heroImage.asset.metadata.dimensions.height}
          ...
          <div className="md:col-span-3 p-6">
            <div className="flex justify-between items-start mb-3">
              <div>
                <h3 className={`${coromantGaramond.className} text-xl font-bold text-charcoal`}>{venueOfTheDay.title[locale]}</h3>
            ...
            <Link href={`/venues/${venueOfTheDay.slug.current}`} className="bg-turquoise text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-turquoise/90 transition-colors">
                View Venue
              </Link></div>
          </div>
        </div>
